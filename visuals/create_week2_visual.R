...
if (!dir.exists("visuals/output")) {
  dir.create("visuals/output", recursive = TRUE)
  message("Created output/visuals/ directory")
}
...
table <- top5_offenses %>%
  ...
  # Style header
  tab_header(
    title = md("**Week 2: Top 5 NFL Offenses by EPA/Play**"),
...
# Save as PNG
output_file <- "visuals/output/week2_top_offenses.png"
